...
<head>
    ...
    <style>
        ...
        .pagetitle {
            ...
            /* Untuk meletakkan elemen di ujung-ujung */
            align-items: center;
            /* Untuk mensejajarkan vertikal */
        }
        ...
        .pagetitle h1 {
            ...
            align-items: center;
            margin-bottom: 0;
            /* Hapus margin-bottom default agar tidak ada spasi di bawah H1 */
        }
        ...
        .pagetitle nav {
            ...
            flex-shrink: 0;
            /* Agar nav tidak menyusut terlalu banyak */
        }
        ...
        .pagetitle .breadcrumb {
            ...
            padding: 0;
            margin: 0;
            /* Hapus margin default breadcrumb */
        }
        ...
        .profile-container {
            max-width: 900px;
            /* Menyesuaikan lebar card utama di gambar */
            margin: 10px auto;
            padding: 0 15px;
        }
        ...
        .profile-info-section .info-value {
            ...
            /* Latar belakang input disabled/read-only */
            border: 1px solid #dee2e6;
            border-radius: 8px;
            padding: 10px 15px;
            margin-bottom: 15px;
            /* Jarak antar info field */
            width: 100%;
        ...
        .profile-info-section textarea.info-value {
            resize: vertical;
            /* Memungkinkan textarea diubah ukurannya secara vertikal */
            min-height: 80px;
            /* Tinggi minimum */
        }
        ...
        .profile-image-section .profile-img {
            ...
            height: 150px;
            border-radius: 10%;
            /* Membulat seperti di gambar */
            object-fit: contain;
            /* Pastikan gambar mengisi area tanpa distorsi */
            border: 3px solid #EFAA31;
            /* Border warna orange/emas */
            padding: 3px;
            /* Sedikit padding sebelum border */
            margin-bottom: 20px;
        }
        ...
        .btn-simpan-profile {
            ...
            /* Warna tombol simpan dari gambar (hijau tua) */
            border-color: #1A877E;
            color: #fff;
            margin-top: 20px;
            /* Jarak atas dari bagian sebelumnya */
        }
        ...
        .btn-primary {
            /* Style untuk tombol "Simpan" di modal */
            padding: 10px 15px;
            border-radius: 8px;
            font-weight: bold;
            background-color: #1A877E;
        ...
        @media (max-width: 768px) {
            .profile-image-section {
                order: -1;
                /* Pindahkan gambar ke atas di layar kecil */
                margin-bottom: 30px;
            }

            .profile-info-section {
                text-align: center;
                /* Tengahkan teks di layar kecil */
            }

            .profile-info-section .info-row {
                flex-direction: column;
                /* Ubah ke kolom untuk baris info */
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 profile-info-section">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control info-value" id="nama_lengkap" name="nama"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="info-row">
                                    ...
                                    <input type="text" class="form-control info-value-inline" id="email_display"
                                        value="<?= substr(htmlspecialchars($user_data['email']), 0, 1) . '*********' . substr(htmlspecialchars($user_data['email']), -8) ?>"
                                        disabled>
                                    <button type="button" class="btn-change" data-bs-toggle="modal"
                                        data-bs-target="#editEmailModal">ganti</button>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="info-row">
                                    ...
                                    <input type="text" class="form-control info-value-inline" id="no_telepon_display"
                                        value="<?= substr(htmlspecialchars($user_data['no_tlp']), 0, 2) . '*********' . substr(htmlspecialchars($user_data['no_tlp']), -2) ?>"
                                        disabled>
                                    <button type="button" class="btn-change" data-bs-toggle="modal"
                                        data-bs-target="#editPhoneModal">ganti</button>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="info-row">
                                    <textarea class="form-control info-value-inline" id="alamat_display" rows="3"
                                        disabled><?= htmlspecialchars($user_data['alamat']) ?></textarea>
                                    <button type="button" class="btn-change" data-bs-toggle="modal"
                                        data-bs-target="#editAddressModal">ganti</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5 profile-image-section">
                            <img src="<?= !empty($user_data['foto']) ? htmlspecialchars($user_data['foto']) : 'https://placehold.co/150x150/cccccc/333333?text=No+Photo'; ?>"
                                alt="Profile Image" class="profile-img">
                            <input type="file" id="foto_profil_input" name="foto_profil" style="display: none;"
                                accept="image/*">
                            <button type="button" class="btn btn-image-action btn-ganti-gambar"
                                onclick="document.getElementById('foto_profil_input').click();">GANTI GAMBAR</button>
                            <button type="submit" name="delete_profile_photo"
                                class="btn btn-image-action btn-hapus-gambar"
                                onclick="return confirm('Apakah Anda yakin ingin menghapus gambar profil?');">HAPUS</button>
                        </div>
                    </div>
                ...
                <form action="update_profile.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="new_email" name="value"
                ...
                <form action="update_profile.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="new_phone" name="value"
                                value="<?= htmlspecialchars($user_data['no_tlp']) ?>" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                ...
                <form action="update_profile.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="new_address" name="value" rows="3"
                                required><?= htmlspecialchars($user_data['alamat']) ?></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
