            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="promo-section">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="promo-card" id="filterDiscount">
                                    <div class="card-body text-center">
                                        <h4 class="card-title">PROMO DISKON</h4>
                                        <p class="card-text">Nikmati berbagai penawaran diskon spesial untuk produk
                                            pilihan</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="promo-card" id="filterBonus">
                                    <div class="card-body text-center">
                            ...
                            <div class="promo-scroll-container">
                                <div class="row promo-row" id="promoContainer" style="margin-left: 40px;">
                                    <?php foreach ($informasipromo as $promo): ?>
                                        <div class="col-md-3 promo-card pt-3" href="promo.php?"
                                            data-type="<?= htmlspecialchars($promo['promo_type']) ?>">
                                            <div class="card">
                                                <?php if (!empty($promo['photo_url'])): ?>
                                                    <img src="../uploads/<?= htmlspecialchars($promo['photo_url']); ?>"
                                                        class="card-img-top" alt="<?= htmlspecialchars($promo['title']) ?>">
                                                <?php else: ?>
                                                ...
                                                <div class="card-body">
                                                    <?php if ($promo['promo_type'] === 'discount'): ?>
                                                        <span class="discount-badge">Diskon
                                                            <?= $promo['discount_percentage'] ?>%</span>
                                                    ...
                                                    <p class="card-text">
                                                        <small class="text-muted">Berlaku sampai:
                                                            <?= htmlspecialchars($promo['end_date']) ?></small>
                                                    </p>
                                                    <div class="countdown mt-3">
                                                        ...
                                                        <span class="days-left">
                                                            ...
                                                            ?>
                                                            <?php if ($promo['promo_type'] === 'discount'): ?>
                                                                <a href="promo.php?id=<?= $promo['id'] ?>" class="btn btn-primary"
                                                                    style="margin-top: 20px;">Lihat Promo</a>
                                                            <?php endif; ?>
                                                        </span>
                                                    </div>
                                                        ...
                                                        <?php if ($promo['promo_type'] === 'bonus' && !empty($promo['bonus_item'])): ?>
                                                            <form method="POST" action="add_to_cart.php" class="d-inline">
                                                                <input type="hidden" name="product_id"
                                                                    value="<?= htmlspecialchars($promo['bonus_item']); ?>">
                                                                <button type="submit" name="add_to_cart" class="btn btn-success">Add
                                                                    to Cart</button>
                                                            </form>
                                                        <?php elseif ($promo['promo_type'] === 'bonus'): ?>
