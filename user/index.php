...
<body>
    ...
    <style>
        ...
        #featuredProductCarousel .featured-image {
            ...
            height: 100%;
            object-fit: contain;
            /* Menggunakan 'contain' sesuai kode terakhir Anda */
    ...
    <main id="main" class="main">
        <div class="main-content">
            <div class="mb-4">
                <h1 class="fs-4 fw-bold mb-2" style="color: var(--casaluxe-dark);"><i class="bi bi-grid me-2"></i>&nbsp;
                    BERANDA</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="#" class="text-decoration-none"
                                style="color: var(--casaluxe-dark);">HOME</a></li>
            ...
            <section class="row g-4 mb-4">
                <div class="col-lg-8">
                    <div id="featuredProductCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel"
                        data-bs-interval="3000">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <a href="#" class="text-decoration-none">
                                    <img src="../assets/img/BARANG A.png" class="d-block featured-image"
                                        alt="Meja Kantor">
                            ...
                            <div class="carousel-item">
                                <a href="#" class="text-decoration-none">
                                    <img src="../assets/img/BARANG B.png" class="d-block featured-image"
                                        alt="Kursi Lounge">
                            ...
                            <div class="carousel-item">
                                <a href="#" class="text-decoration-none">
                                    <img src="../assets/img/BARANG C.png" class="d-block featured-image"
                                        alt="Bangku Ottoman">
                                    <div class="product-name-overlay">Kursi Kantor Hitam</div>
                                </a>
                            </div>
                        </div>
                        <button class="carousel-control-prev" type="button" data-bs-target="#featuredProductCarousel"
                            data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span><span
                                class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#featuredProductCarousel"
                            data-bs-slide="next">
                ...
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div
                        class="card shadow-sm p-3 text-center d-flex flex-column justify-content-center align-items-center w-100">
                        <img src="../assets/img/BARANG B.png" alt="Product Tersedia" class="img-fluid rounded mb-3"
                        ...
                        <a href="detail_produk.php?product_id=3">
                            <button class="btn btn-casaluxe-primaryy fw-bold py-2 px-4 rounded-lg shadow-sm">TERSEDIA
                                SEKARANG</button>
                        </a>
            ...
            <section class="mb-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="produk.php" class="text-decoration-none fw-semibold d-flex align-items-center"
                        style="color: var(--casaluxe-primary);">
                        ...
                        if ($product['stok'] > 0) {
                            ...
                            <form method="POST" action="checkout.php">
                                ...
                                <button type="submit" name="buy_now"
                                    class="btn btn-casaluxe-primary btn-sm fw-semibold w-100">Beli Sekarang</button>
                            </form>
                            <form method="POST" action="add_to_cart.php">
                                <input type="hidden" name="product_id" value="<?= $product['id_produk']; ?>">
                                <button type="submit" name="add_to_cart"
                                    class="btn btn-outline-casaluxe-primary btn-sm fw-semibold w-100">Masuk Keranjang</button>
                            </form>
                            <?php
                        } else {
                            ?>
