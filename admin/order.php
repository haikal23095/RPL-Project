...
// Create PDO connection using the existing mysqli connection credentials
try {
    ...
    <main id="main" class="main">
        <div class="main-content">
            ...
            <div class="page-header">
                ...
                <!-- Cancel Button -->
                <a href="pesanan_dibatalkan.php" class="btn cancel-button text-white"
                    style="background: linear-gradient(to right, #EFAA31, #FF8A0D); font-weight: 600;">PESANAN
                    DIBATALKAN</a>
            </div>
                ...
                <form method="GET" class="row">
                    <div class="col-md-3">
                        <select name="status" class="form-select" onchange="this.form.submit()">
                            ...
                            <option value="Diproses" <?= $status_filter == 'Diproses' ? 'selected' : '' ?>>Diproses
                            </option>
