  ...
  <div class="main-content">
    ...
    <div class="special-offers">
      <div class="game-card">
        ...
        <img src="/GameGlee/Gamify/assets/img/NINTENDO/GAME/Kirbys Return to Dream Land Deluxe.jpg" alt="Kirbys Return to Dream Land Deluxe">
      </div>
      <div class="game-card">
        <div class="card-info">
          <button class="game-button">Available Now!</button>
        </div>
        <a href="detail_produk.php"><img src="/GameGlee/Gamify/assets/img/PLAYSTATION/GAME/God of War Ragnarök.png" alt="God of War Ragnarök"></a>
      </div>
      <div class="game-card">
        <div class="card-info">
          <button class="game-button">Available Now!</button>
        </div>
        <a href="detail_produk.php"><img src="/GameGlee/Gamify/assets/img/PLAYSTATION/GAME/Gran Turismo 7 (English Chinese Korean Thai Ver.).png" alt="Gran Turismo 7 (English Chinese Korean Thai Ver.)"></a>
      </div>
      <div class="game-card">
        <div class="card-info">
          <button class="game-button">Available Now!</button>
        </div>
        <a href="detail_produk.php"><img src="/GameGlee/Gamify/assets/img/XBOX/GAME/Call of Duty  Black Ops 6 - Vault Edition Upgrade.jpeg" alt="Call of Duty  Black Ops 6 - Vault Edition Upgrade"></a>
      </div>
    </div>
  </div>
