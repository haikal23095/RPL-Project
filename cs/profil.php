                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 profile-info-section">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control info-value" id="nama_lengkap" name="nama" value="<?= htmlspecialchars($cs['nama']) ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="info-row">
                                    ...
                                    <input type="text" class="form-control info-value-inline" id="email_display" value="<?= substr(htmlspecialchars($cs['email']), 0, 1) . '*********' . substr(htmlspecialchars($cs['email']), -8) ?>" disabled>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="info-row">
                                    ...
                                    <input type="text" class="form-control info-value-inline" id="no_telepon_display" value="<?= substr(htmlspecialchars($cs['no_tlp']), 0, 2) . '*********' . substr(htmlspecialchars($cs['no_tlp']), -2) ?>" disabled>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="info-row">
                                    <textarea class="form-control info-value-inline" id="alamat_display" rows="3" disabled><?= htmlspecialchars($cs['alamat']) ?></textarea>
